...
public static class SaveLoad {
	...
	public static void SaveScene(SaveGame saveGame, string saveGamePath) {
		...
		FileStream file = File.Create (saveGamePath + saveGame.savegameName + ".TonyEsPuto"); //you can call it anything you want including the file extension
		bf.Serialize(file, saveGame);
		file.Close();
	}	

	public static void DeleteScene(String saveGameName, string saveGamePath){
		...
		File.Delete (saveGamePath + saveGameName + ".TonyEsPuto"); 
	}
	...
	public static SaveGame LoadScene(string gameToLoad, string saveGamePath) {
		...
		if(File.Exists(saveGamePath + gameToLoad + ".TonyEsPuto")) {
			...
			FileStream file = File.Open(saveGamePath + gameToLoad + ".TonyEsPuto", FileMode.Open);
	...
	public static List<SaveGame> GetSaveGames(string path, bool usePersistentDataPath) {
		...
		List<FileInfo> info = dir.GetFiles("*.TonyEsPuto", SearchOption.AllDirectories).ToList();
	...
	public static void DeleteFile(string path, string fileName) {
		if(File.Exists(path + fileName + ".TonyEsPuto")) {
			File.Delete(path + fileName + ".TonyEsPuto");
		}
	}
}
